            ...
            module = {
                ...
                can: {
                    ...
                    fit: function () {
                        ...
                        let scrollingTop = module.cache.scrollingTop || 0;
                        let scrollHeight = module.cache.scrollHeight - (module.cache.bottomMargin || 0);
                ...
                set: {
                    ...
                    modalOffset: function () {
                        if (!settings.detachable) {
                            ...
                            let scrollTop = (isBody ? $document : $context).scrollTop();
                            $module
                                .css({
