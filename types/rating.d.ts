declare namespace FomanticUI {
    ...
    namespace RatingSettings {
        ...
        interface _Impl {
             ...
             * 
             */
            metadata: Rating.MetadataSettings;

            /**
             * 
             */
            cssVars: Rating.CssVarsSettings;

            /**
             * DOM Selectors used internally.
             * Selectors used to find parts of a module.
             */
            templates: Rating.TemplateSettings;
        ...
        namespace Rating {
            ...
            namespace ClassNameSettings {
                type Param = (Pick<_Impl, 'active'> | Pick<_Impl, 'disabled'> | Pick<_Impl, 'selected'> | Pick<_Impl, 'loading'> | Pick<_Impl, 'partiallyActive'>) &
                    Partial<Pick<_Impl, keyof _Impl>>;
            ...
            namespace MetadataSettings {
                type Param = (Pick<_Impl, 'rating'> | Pick<_Impl, 'maxRating'> | Pick<_Impl, 'icon'>) &
                    Partial<Pick<_Impl, keyof _Impl>>;
            ...
            type CssVarsSettings = CssVarsSettings.Param;

            namespace CssVarsSettings {
                type Param = Pick<_Impl, 'filledCustomPropName'> &
                    Partial<Pick<_Impl, keyof _Impl>>;
            ...
            namespace TemplateSettings {
                type Param = (Pick<_Impl, 'deQuote'> | Pick<_Impl, 'icon'>) &
                    Partial<Pick<_Impl, keyof _Impl>>;
                ...
                interface _Impl {
                     ...
                     * 
                     */
                    deQuote(string: string, encode?: string): void;
            ...
            namespace ErrorSettings {
                type Param = (Pick<_Impl, 'method'> | Pick<_Impl, 'noMaximum'>) & Partial<Pick<_Impl, keyof _Impl>>;
                ...
                interface _Impl {
                    ...
                    /**
                     * @default 'No maximum rating specified. Cannot generate HTML automatically'
                     */
                    noMaximum: string;
                }
            }
